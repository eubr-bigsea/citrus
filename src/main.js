...
Vue.filter('elapsedSeconds', (d1, d2) => {
    const v = differenceInSeconds(parseISO(d1), parseISO(d2)) + '';
    return v.padStart(2, '0');
});
Vue.filter('elapsedMinutes', (d1, d2) => {
    const v = differenceInMinutes(parseISO(d1), parseISO(d2)) + '';
    return v.padStart(2, '0');
