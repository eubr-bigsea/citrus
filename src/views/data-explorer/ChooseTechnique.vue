    ...
    <main role="main">
        <div>
            <div class="d-flex justify-content-between align-items-center">
                <h1>Escolha a técnica que você quer usar</h1>
            </div>
            <hr>
            <div class="card-deck">
                <b-card class="clickable" @click="navigate('explorer-mode', {technique: 'classification'})">
                    <div class="row">
                ...
                <b-card class="clickable" @click="navigate('explorer-mode', {technique: 'regression'})">
                    <div class="row">
                        <div class="col-md-3 text-center">
                            <span class="fa-stack fa-2x">
                        ...
                        <div class="col-md-9 text-center">
                            ...
                            <small>
                                ...
                                ou encontrar anomalia nos dados.
                            </small>
                        </div>
                    </div>
                </b-card>
            ...
            <div class="card-deck mt-4">
                <b-card class="clickable" @click="navigate('explorer-model-training')">
                    <div class="row">
                        ...
                        <div class="col-md-9 text-center">
                            <h6>Mineração de padrões frequentes</h6>
                            <small>
                                Buscar padrões em conjuntos de dados, transações ou operações que
                                estatisticamente não eram esperados.
                            </small>
                        </div>
                    </div>
                </b-card>
                <b-card class="clickable" @click="navigate('explorer-model-training')">
                    <div class="row">
                        ...
                        <div class="col-md-9 text-center">
                            <h6>Redução de dimensionalidade / Sumarização</h6>
    ...
    <div>
                ...
                <div v-if="step === 2">
                    ...
                    <div class="row">
                        ...
                        <div class="offset-md-2 col-md-4 text-secondary xtext-center">
