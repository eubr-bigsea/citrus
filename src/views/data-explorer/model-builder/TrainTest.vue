<template lang="">
    <div class="row">
        ...
        <div class="col-6">
            ...
            <select v-model="split.forms.strategy.value"
            ...
            <template v-if="split.forms.strategy.value === 'split'">
                ...
                <input v-model="split.forms.ratio.value"
                       type="number"
            ...
            <template v-if="split.forms.strategy.value === 'cross_validation'">
                ...
                <input v-model.number="split.forms.folds.value"
                       type="number"
                       class="form-control form-control-sm w-25"
                       min="2"
                       max="100"
            ...
            <template v-if="split.forms.strategy.value">
                ...
                <input v-model.number="split.forms.seed.value"
                       type="number"
                       class="form-control form-control-sm w-25"
                       min="0"
                       maxlength="15"
