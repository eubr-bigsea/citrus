    ...
    <div>
        ...
        <div class="row">
            <div class="col-4">
                ...
                <select v-model="reduction.forms.method.value" class="form-control form-control-sm mb-3"
                    data-test="reduction">
                ...
                <template v-if="reduction.forms.method.value === 'pca'">
                    ...
                    <input v-model.number="reduction.forms.k.value" type="number"
                        class="form-control form-control-sm w-25" maxlength="4" step="1" min="2" />
                </template>
            </div>
            <div class="col-8">
