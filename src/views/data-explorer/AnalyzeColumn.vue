                                ...
                                <table class="table table-sm table-striped small-text no-border-row1">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                MG
                                                <div class="quality-other border"
...
import QualityBar from './QualityBar.vue';
