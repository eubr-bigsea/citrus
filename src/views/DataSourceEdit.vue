                    ...
                    <b-tab title="Basic information" active>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <v-select multiple style="width: 100%" v-model="missing" :taggable="true" class="custom"><slot name="no-options">{{$t('message.noMatching')}}.</slot></v-select>
                            </div>
                            ...
                            <div class="col-md-12" v-if="dataSource.format === 'CSV'">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <v-select style="width: 250px" v-model="dataSource.attribute_delimiter" :options="delimiters" :taggable="true"><slot name="no-options">{{$t('message.noMatching')}}.</slot></v-select>
                                    </div>
                                    <div class="col-md-3">
                                        <label>{{ $t('dataSource.recordDelimiter') }}: </label>
                                        <v-select style="width: 250px" v-model="dataSource.record_delimiter" :options="delimiters" :taggable="true"><slot name="no-options">{{$t('message.noMatching')}}.</slot></v-select>
                                    </div>
                                    <div class="col-md-3">
                                        <label>{{ $t('dataSource.textDelimiter') }}: </label>
                                        <v-select style="width: 250px" v-model="dataSource.text_delimiter" :options="textDelimiters" :taggable="true"><slot name="no-options">{{$t('message.noMatching')}}.</slot></v-select>
                                    </div>
                                    <div class="col-md-3">
                                        <label>{{ $t('dataSource.encoding') }}: </label>
                                        <v-select style="width: 100%" v-model="dataSource.encoding" :options="encodings" :taggable="true"><slot name="no-options">{{$t('message.noMatching')}}.</slot></v-select>
                                    </div>
