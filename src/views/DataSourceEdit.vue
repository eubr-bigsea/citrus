            ...
            <div class="col-md-12 col-xg-12 mx-auto" v-if="dataSource.id">
              <b-card no-body>
                  ...
                  <b-tab :title="$t('dataSource.basicInformation')" active>
                    <div class="row">
                      ...
                      <div class="col-md-6 mt-3 mb-3 mt-3" v-if="dataSource.format === 'CSV'">
                        <b-form-checkbox
                          v-model="dataSource.is_first_line_header"
                        >{{ $t('dataSource.isFirstLineHeader') }}</b-form-checkbox>
                        <b-form-checkbox
                          v-model="dataSource.is_multiline"
                      ...
                      <div class="col-md-12 mt-3 mt-3 pb-1" v-if="dataSource.format === 'CSV'">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            ...
                            <v-select
                              style="width: 100%"
                              v-model="dataSource.record_delimiter"
                              :options="delimiters"
                              :taggable="true"
                            >
                              <span slot="no-options">{{$t('messages.noMatching')}}.</span>
                      ...
                      <tbody>
                        <tr v-for="(attr, index) in dataSource.attributes" :key="attr.id">
                          ...
                          <td>
                            <input
                              class="form-control-sm form-control"
                              v-model="attr.missing_representation"
                              maxlength="200"
                            >
                          </td>
                        </tr>
                ...
                <div class="col-md-12 mb-4 border-top pt-2">
                  ...
                  <button
                    class="btn btn-success ml-1 btn-spinner"
                    @click.stop="infer"
                    v-if="canInfer"
                  >
                    <font-awesome-icon icon="spinner" pulse class="icon"/>
                  ...
                  <button class="btn btn-spinner ml-1 btn-outline-info" @click.stop="preview" :disabled="isDirty">
                    ...
                    &nbsp;
                    <span
                      v-text="isDirty ? $t('common.saveBeforeToEnableThis', {what: $t('common.preview')}): $t('common.preview')"
                    ></span>
                  </button>
                </div>
              </b-card>
