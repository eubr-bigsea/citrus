                    ...
                    <div class="col-md-9 col-xg-9 mx-auto border">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input v-model="storage.name" type="text" class="form-control" required maxlength="100">
                            </div>
                            <div class="col-md-2">
                                <label class="font-weight-bold">{{$tc('common.type')}}:</label>
                                <select v-model="storage.type" class="form-control" required>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea v-model="storage.extra_params" class="form-control"></textarea>
                            </div>
                        </div>
