                                                ...
                                                <table class="table table-striped">
                                                    <div v-for="platform in platforms" :key="platform.id"
                                                        ...
                                                        <tr class="d-flex">
                                                            <td class="col-3">
                                                                <b-form-radio
                                                                    v-if="platform.subsets && platform.subsets.length == 0 || !(hasAnyPermission(['APP_EDIT']) || isAdmin)"
                                                ...
                                                <tr v-for="template in templates" :key="template.id" class="d-flex">
                                                    <td class="col-3">
                                                        <b-form-radio v-model="selectedTemplate" :value="template.id"
                                                            name="templateCheck" @change="selectOne">{{template.name}}
                                                        </b-form-radio>
                                                    </td>
                                                    <td class="col-6">
                                                        <em>{{template.description}}.</em>
                                                    </td>
                                                    <td class="col-3">{{template.platform ? template.platform.name: ''}}
                                                    </td>
                                                </tr>
                                            </table>
                                            <div v-else>
