    ...
    <div class="not-found-div">
        <svg width="380px" height="500px" viewBox="0 0 837 1045" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                ...
                <circle id="Polygon-1" cx="300" cy="280" r="300" stroke="#007FB2" stroke-width="6" xfill="#28a745" />
        ...
        <div class="message-box">
            <h1>404</h1>
            <p>{{$t('titles.pageNotFound')}}</p>
            <div>
                <router-link :to="{name: 'home'}" class="btn btn-primary btn-sm">{{$t('actions.back')}}</router-link>
            </div>
        </div>
    </div>
</template>
