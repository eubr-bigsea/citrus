export default {
    pt: {
        actions: {
            ...
            typeAndchooseOption: 'Digite o texto para pesquisa e escolha uma opção ...',
        },
        common: {
            action: 'Ação | Ações',
            author: 'Autor',
        ...
        deployment: {
            requireExecution: 'Uma execução do fluxo de trabalho é necessária para a implantação do fluxo como um serviço. ' +
                'Para que uma execução possa ser usada, ela tem que ter sido concluída com sucesso. ' +
                'Caso não aparece nenhuma execução para o fluxo, certifique-se de que o fluxo foi realmente executado anteriormente.',
    ...
    en: {
        actions: {
            ...
            typeAndchooseOption: 'Inform the text for searching an choose an option ...'
        },
        common: {
