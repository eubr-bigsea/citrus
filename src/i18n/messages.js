export default {
    pt: {
        ...
        actions: {
            ...
            addSourceCode: 'Adicionar Código Fonte',
        ...
        common: {
            ...
            true: 'Verdadeiro',
            type: 'Tipo | Tipos',
            typeToSearch: 'Digite parte do nome para pesquisar...',
            until: 'Até',
            updated: 'Atualizado',
            url: 'URL',
        ...
        titles: {
            ...
            order: 'Ordem',
            pageNotFound: 'Página não encontrada',
            peelPlatform: 'Plataforma Peel',
            pipeline: 'Pipeline | Pipelines',
            pipelineRuns: 'Execução da Pipeline | Execuções das Pipelines',
        ...
        pipeline: {
            ...
            alerts: {
                ...
                stepCreationSuccess: 'Etapa adicionada com sucesso',
                stepDeletionSuccess: 'Etapa excluída com sucesso',
                stepNotAssociated: 'Etapa não associada a um fluxo de trabalho',
                successfullyAssociated: 'Fluxo de trabalho associado com sucesso à etapa',
                successfullyCreatedAssociated: 'Fluxo de trabalho criado e associado com sucesso à etapa',
            ...
            edit: {
                ...
                addStepsToPipeline: 'Adicione etapas à sua pipeline',
                addStepsToAccess: 'Adicione etapas à sua pipeline para acessar suas informações de agendamento e configurações.',
                daily: 'Diário',
                weekly: 'Semanal',
                monthly: 'Mensal',
                definePeriodicity: 'Defina a periodicidade da execução da pipeline',
                deleteStep: 'Excluir etapa',
                executionPeriodicity: 'Periodicidade da execução',
                intervalDays: 'Intervalo de dias',
                intervalWeeks: 'Intervalo de semanas',
                intervalMonths: 'Intervalo de meses',
                periodicity: 'Periodicidade',
                periodicityIntervalOptional: 'Intervalo (opcional)',
                periodicityStart: 'Iniciar',
                pipelineInfo: 'Informações da Pipeline',
                pipelinePeriodicity: 'Periodicidade da Pipeline',
                pipelineSteps: 'Etapas da Pipeline',
                schedulerLabel: 'Agendador',
                selectPeriodicity: 'Selecione a periodicidade',
                ...
                scheduler: {
                    ...
                    selectMonths: 'Selecione os meses',
                ...
                settings: {
                    ...
                    stepLinkedToWorkflow: 'Etapa associada a um fluxo de trabalho',
            ...
            schedule: {
                addContextData: 'Adicionar',
                contextData: 'Dados de contexto',
                contextName: 'nome',
                contextValue: 'valor',
                noContextData: 'Nenhum dado de contexto adicionado.',
                scheduleTitle: 'Agendar pipeline',
                scheduleInstructions: 'Informe o mês de referência de agendamento da pipeline. Atualmente, você deve usar esta função apenas se a periodicidade da pipline é mensal. Desta forma, informe como data inicial e a data final como o primeiro e último dias do mês, respectivamente.',
            },
            template: {
                holdAndDragSteps: 'Segure e arraste as etapas abaixo para reordená-las.',
                noStepsTemplate: 'Modelo sem etapas.',
                pipelineTemplates: 'Modelos para Pipeline',
                templateCreation: 'Criação de modelo',
                templateDescription: 'Descrição do modelo',
                templateEdition: 'Edição do modelo',
                templateName: 'Nome do modelo',
                templateNameMinLength: 'Nome do modelo deve ter pelo menos 3 caracteres.',
    ...
    en: {
        ...
        common: {
            ...
            true: 'True',
            type: 'Type | Types',
            typeToSearch: 'Type part of the name to search...',
            until: 'Until',
            updated: 'Updated',
            url: 'URL',
            userId: 'User id',
        ...
        titles: {
            ...
            login: 'Login',
            pageNotFound: 'Page not found',
            peelPlatform: 'Peel Platform',
            pipeline: 'Pipeline | Pipelines',
            pipelineRuns: 'Pipeline Run | Pipeline Runs',
        ...
        pipeline: {
            ...
            alerts: {
                ...
                stepCreationSuccess: 'Step successfully added',
                stepDeletionSuccess: 'Step successfully deleted',
                stepNotAssociated: 'Step not associated to a workflow',
                successfullyAssociated: 'Workflow successfully associated to step',
                successfullyCreatedAssociated: 'Workflow created and successfully associated to step',
                templateCreationSuccess: 'Template successfully created',
                templateEditionSuccess: 'Template successfully edited',
            },
            edit: {
                addStep: 'Add step',
                addStepsToPipeline: 'Add steps to your pipeline',
                addStepsToAccess: 'Add steps to your pipeline to access your scheduling information and settings.',
                daily: 'Daily',
                weekly: 'Weekly',
                monthly: 'Monthly',
                definePeriodicity: 'Define the periodicity of pipeline execution',
                deleteStep: 'Delete step',
                executionPeriodicity: 'Execution periodicity',
                intervalDays: 'Interval of days',
                intervalWeeks: 'Interval of weeks',
                intervalMonths: 'Interval of months',
                periodicity: 'Periodicity',
                periodicityIntervalOptional: 'Interval (optional)',
                periodicityStart: 'Start',
                pipelineInfo: 'Pipeline Information',
                pipelinePeriodicity: 'Pipeline Periodicity',
                ...
                scheduler: {
                    ...
                    selectMonths: 'Select the months',
                    selectWeekDays: 'Select the week days',
                    triggeredByUser: 'Triggered by user',
                },
                settings: {
                    chooseExistingWorkflow: 'Choose an existing workflow to link to this step',
                    existingWorkflow: 'Existing workflow',
                    linkStepToWorkflow: 'Link step to a workflow',
                    newWorkflow: 'New workflow',
                    stepLinkedToWorkflow: 'Step linked to a workflow',
            ...
            schedule: {
                ...
                contextName: 'name',
                contextValue: 'value',
                noContextData: 'No context data added.',
                scheduleTitle: 'Schedule pipeline',
                scheduleInstructions: 'Enter the reference month for scheduling the pipeline. Currently, you should only use this function if the pipeline periodicity is monthly. This way, enter the first and last days of the month as the start and end date, respectively.',
            },
            template: {
                holdAndDragSteps: 'Hold and drag the steps below to reorder them.',
                noStepsTemplate: 'Template without steps.',
                pipelineTemplates: 'Pipeline Templates',
                templateCreation: 'Template Creation',
                templateDescription: 'Template Description',
                templateEdition: 'Template Edition',
                templateName: 'Template Name',
                templateNameMinLength: 'Template name must have at least 3 characters.',
