export default {
    pt: {
        ...
        assets: {
            ...
            EXPERIMENT_EXPLORER: 'Explorador de dados',
            EXPERIMENT_MODEL: 'Construtor de modelos',
            EXPERIMENT_SQL: 'Fluxo SQL',
            EXPERIMENT_VISUALIZATION: 'Construtor de visualizações',
            JOB: 'Execução | Execuções',
            PIPELINE: 'Pipeline | Pipelines',
            PIPELINE_RUN: 'Execução de pipeline | Execuções de pipelines',
