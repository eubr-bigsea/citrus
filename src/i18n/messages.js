export default {
    pt: {
        ...
        titles: {
            ...
            pipelineTemplates: 'Templates para Pipeline',
        ...
        variables: {
            ...
            name: 'Nome',
            names: {
                second: 'Segundo atual',
                minute: 'Minuto atual',
                hour: 'Hora atual, de 00 a 23',
                day: 'Dia atual do mês',
                week_day: 'Dia atual da semana, de 1 a 7, sendo segunda o primeiro e domingo o último',
                month: 'Mês atual do ano, de 01 a 12',
                year: 'Ano atual no formato YYYY, por exemplo, 2024',
                year2: 'Ano atual no formato YY, por exemplo, 24',
                date: 'Data atual',
    ...
    en: {
        ...
        variables: {
            ...
            names: {
                ...
                hour: 'Current hour, from 00 to 23',
                day: 'Current day of the month',
                week_day: 'Current day of the week, from 1 to 7, being monday the first one and sunday the last',
                month: 'Current month of the year, from 01 to 12',
                year: 'Current year in the YYYY format, e.g. 2024',
                year2: 'Current year in the YY format, e.g. 24',
                date: 'Current date',
