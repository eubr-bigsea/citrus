        ...
        <b-modal ref="modal" size="lg" :title="`${field.label} - ${label || ''}`"
            ...
            <div class="row border-top mt-2 pt-2">
                <div class="offset-md-2 col-md-2">
                    ...
                    <input v-model="coordinates.row" type="number" min="0" max="100" name="x" class="form-control"/>
                </div>
                <div class="col-md-2">
                    <label for="column">{{$tc('common.column', 1)}}</label>
                    <input v-model="coordinates.column" type="number" min="0" max="12" name="y" class="form-control"/>
                </div>
                <div class="col-md-2">
                    <label for="width">{{$tc('common.width', 1)}}</label>
                    <input v-model="coordinates.width" type="number" min="1" max="12" name="width" class="form-control"/>
                </div>
                <div class="col-md-2">
                    <label for="height">{{$tc('common.height', 1)}}</label>
                    <input v-model="coordinates.height" type="number" min="1" max="10" name="height" class="form-control"/>
                </div>
            </div>
