<template>
    <div class="function-editor">
        ...
        <b-modal ref="modal" size="xl" :title="$tc('common.filter', 2)" hide-header>
            <div class="p-1">
                        ...
                        <div v-if="selected" class="form-filter ">
                            <b-tabs class="filter-field">
                                ...
                                <b-tab :title="$tc('variables.text', 2)">
                                    ...
                                    <textarea v-model="selected.textBefore" maxlength="300" autocomplete="off"
                                        class="form-control" rows="4"></textarea>
                                    <label>{{$t('variables.textAfter')}}:</label>
                                    <textarea v-model="selected.textAfter" maxlength="300" autocomplete="off"
                                        class="form-control" rows="4"></textarea>
                                </b-tab>
                            </b-tabs>
                        </div>
