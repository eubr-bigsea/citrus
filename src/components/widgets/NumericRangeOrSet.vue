<template>
    <div>
        ...
        <div class="row">
            <div class="col-10">
                <div v-if="internalValue.type === 'range'"
                     class="border p-1 pl-2 border-radius">
                    <b-form inline>
                        <label for="inline-form-input-name">Min:</label>
                        <input v-model.number="internalValue.min"
                               type="number"
                        ...
                        <input v-model.number="internalValue.max"
                               type="number"
                               class="form-control form-control-sm ml-2 mr-2 small-text"
                               onKeyPress="return this.value.length < 12">
                        ...
                        <template v-if="showQuantity">
                            ...
                            <input v-model.number="internalValue.quantity"
                                   type="number"
                                   min="1"
                                   class="form-control form-control-sm ml-2 mr-2 small-text"
                                   onKeyPress="return this.value.length < 12">
            ...
            <div class="col-2 text-right">
                <b-form-radio-group v-model="internalValue.type"
                                    :options="opts"
