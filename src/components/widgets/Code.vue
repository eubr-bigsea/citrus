    ...
    <div>
        ...
        <template v-else>
            ...
            <div class="border p-2">
                <prism-editor ref="prism" v-model="code" :highlight="highlighter"
                    class="prism-editor-wrapper-disabled code2" :readonly="false" />
            </div>
        ...
        <b-modal ref="modal" size="xl" :title="field.label" ok-disabled :cancel-title="$t('actions.cancel')" no-fade>
            <div slot="default">
                <div class="row">
                    <div class="col-md-8">
                        <div class="border p-2">
                            <prism-editor ref="prismEditor" v-model="code" :highlight="highlighter" class="my-editor"
                                @input="handleInput" />
                        </div>
                    </div>
