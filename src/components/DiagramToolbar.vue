    ...
    <div class="row pb-2">
        <div class="col-md-8 col-sm-12">
            <b-button-toolbar>
                ...
                <b-btn class="mr-1" size="sm" variant="primary" @click.prevent="saveWorkflow"
                    :title="$t('actions.save')">
                    <span class="fa fa-save"></span> {{$t('actions.save')}}
                </b-btn>
                <b-btn class="mr-1" size="sm" variant="secondary" @click.prevent="saveWorkflowAs"
                    :title="$t('actions.saveAs')">
                    <span class="fa fa-copy"></span> {{$t('actions.saveAs')}}...
                </b-btn>
                <b-btn class="mr-1" size="sm" variant="secondary" @click.prevent="showHistory"
                ...
                <b-input-group size="sm" class="w-25">
                    <b-form-input v-model="workflow.name"></b-form-input>
                </b-input-group>
            </b-button-toolbar>
        </div>
        <div class="col-sm-12 col-md-4">
            <b-button-toolbar class="float-right">
                <b-button-group size="sm" class="mx-1">
                    <b-btn size="sm" variant="secondary" @click.prevent="align('left', 'min')"
                        :title="$t('actions.alignLeft')">
                        <span class="object-align-left"></span>
                    </b-btn>
                    <b-btn size="sm" variant="secondary" @click.prevent="align('left', 'max')"
                        :title="$t('actions.alignRight')">
                        <span class="object-align-right"></span>
                    </b-btn>
                    <b-btn size="sm" variant="secondary" @click.prevent="align('top', 'min')"
                        :title="$t('actions.alignTop')">
                        <span class="object-align-top"></span>
                    </b-btn>
                    <b-btn size="sm" variant="secondary" @click.prevent="align('top', 'max')"
                        :title="$t('actions.alignBottom')">
                        <span class="object-align-bottom"></span>
                    </b-btn>
                </b-button-group>
                <b-button-group size="sm" class="mx-1">
                    <b-btn size="sm" variant="secondary" @click.prevent="distribute('horizontal', 'left')"
                        :title="$t('actions.distributeHorizontally')">
                        <span class="fa fa-arrows-alt-h"></span>
                    </b-btn>
                    <b-btn size="sm" variant="secondary" @click.prevent="distribute('vertical', 'top')"
                ...
                -->
                    <b-btn size="sm" variant="secondary" @click.prevent="toggleTasks"
                        :title="$t('actions.toggleTasks')">
                ...
                <b-form-select v-model="zoom" class="ml-1" style="width:68px" :options="[
                    {value: .6, text: '60%'},
                    {value: .7, text: '70%'},
                    {value: .8, text: '80%'},
                    {value: .9, text: '90%'},
