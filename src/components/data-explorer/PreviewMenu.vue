    ...
    <div class="border preview-menu">
        <b-nav>
            ...
            <b-nav-item-dropdown text="Editar" toggle-class="nav-link-custom" :disabled="selected.label === undefined">
                ...
                <template v-if="selected.field.type === 'Date' || selected.field.type == 'Time' ">
                    <b-dropdown-item class="ctx-divider"></b-dropdown-item>
                    <b-dropdown-item>
                    ...
                    <b-dropdown-item v-if="selected.field.type === 'Date'">
                        <b>Extract</b> date components 
                    </b-dropdown-item>
                    <b-dropdown-item v-if="selected.field.type === 'Time'">
            ...
            <b-nav-item-dropdown text="(De)codificar" toggle-class="nav-link-custom"
                :disabled="selected.label === undefined">
                <template slot="button-content">
                    <span class="fa fa-code"></span> {{$t('actions.encodeDecode')}}
                </template>
                <!--
            ...
            <b-nav-item-dropdown text="Sinalizar" toggle-class="nav-link-custom"
                :disabled="selected.label === undefined">
                <template slot="button-content">
                    <span class="fa fa-flag"></span> {{$t('actions.flag')}}
                </template>
                <b-dropdown-item>
            ...
            <b-nav-item-dropdown text="Corrigir" toggle-class="nav-link-custom"
                :disabled="selected.label === undefined">
                <template slot="button-content">
                    <span class="fa fa-eraser"></span> {{$t('actions.fix')}}
                </template>
                <template>
                    ...
                    <!--
                    <b-dropdown-item>
                        <b>Remove invalid rows</b> for meaning <em>{{selected.field.type}}</em>
                    </b-dropdown-item>
                    <b-dropdown-item>
                        <b>Clear invalid cells</b> for meaning <em>{{selected.field.type}}</em>
                    </b-dropdown-item>
                    -->
                </template>
            </b-nav-item-dropdown>
