                ...
                <div>
                    ...
                    <b-dropdown dropright v-if="workflow.group.forms.attributes.value" size="sm" ref="axis"
                        ...
                        <b-dropdown-form form-class="right-drop-form">
                            <div class="row">
                                <div class="col-6">
                                    <b-form-group :label="$tc('common.attribute', 2) + ':'"
            ...
            <b-card sub-title="Eixo Y" class="mt-1" style="z-index:10">
                ...
                <div>
                    <div>
                        ...
                        {{ workflow.group.forms.function.value[0].f.toUpperCase() }}({{ workflow.group.forms.function.value[0].attribute }})
                    </div>
                    <b-dropdown dropright v-if="workflow.group.forms.attributes.value" size="sm" ref="axis"
                        class="mt-2 pull-right" variant="outline-secondary" style="width: 100%;">
                        <template #button-content>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <b-form-group label="Faixa de valores:">
                                        ...
                                        <input type="number" class="form-input-sm" placeholder="min" />
                                        <input type="number" class="form-input-sm" placeholder="max" />
