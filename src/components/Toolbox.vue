            ...
            >
              ...
              <b-collapse :id="'submenu' + index" data-parent="submenus">
                <div v-if="group.operations">
                  ...
                  >
                    <a
                      class="list-group-item truncate list-group-item-action text-dark OLE"
                      draggable="true"
                ...
                <div v-else>
                  <div
                    v-for="(subGroup, index2) in group.subGroups"
                    :key="subGroup.subGroup"
                  >
                    <b-link
                      v-b-toggle="`subsubmenu_${index}+${index2}`"
                      draggable="false"
                      class="list-group-item truncate list-group-item-action flex-column align-items-start"
                    >
                    ...
                    <b-collapse
                      v-for="op in subGroup.operations"
